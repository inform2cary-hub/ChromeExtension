...
This file is the publishable privacy policy. Host it at a public URL (GitHub Pages works) and put
that URL in the **Privacy practices → Privacy policy URL** field of the Developer Dashboard. The
URL must be reachable without a login.

Placeholders are already filled in (effective date 18 September 2026, contact
inform2cary@gmail.com). Publish everything below the horizontal rule; this note is not part of
the policy.

> This is a legal document for an extension that transmits page text to a third party. Keep it
> precise. If you change what the extension sends, change this first.
