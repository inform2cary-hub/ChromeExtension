...
#
# Output:
#   dist\ai-bilingual-translate-<version>.zip   (upload this to Chrome Web Store)
#   dist\ai-bilingual-translate-<version>.crx   (only with -Crx, for enterprise policy hosting)
#   dist\ai-bilingual-translate.pem             (signing key, created once, KEEP IT SECRET)
#
